...
const csvSchema = [
  { field: "full_name", type: "string", required: true },
  { field: "email", type: "string", required: true },
  { field: "phone", type: "string", required: false },
  { field: "linkedin_url", type: "string", required: false },
  { field: "current_title", type: "string", required: true },
  { field: "company", type: "string", required: false },
  { field: "years_experience", type: "number", required: false },
  { field: "source_tag", type: "string", required: true },
];
          ...
          <div className="grid gap-6 lg:grid-cols-5">
            ...
            <motion.div variants={fadeUp} className="lg:col-span-2">
              <div className="glass noise rounded-2xl p-6 h-full">
                ...
                {/* Upload zone */}
                <div className="group relative mb-5 cursor-pointer rounded-xl border-2 border-dashed border-white/10 bg-white/[0.02] p-8 text-center transition hover:border-accent/40 hover:bg-accent/5">
