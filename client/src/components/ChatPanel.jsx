        ...
        {open && (
          ...
          >
            ...
            <div className="border-b border-amber-400/20 bg-amber-400/10 px-4 py-2">
              ...
              <p className="text-[11px] leading-snug text-amber-300/90 mt-1">
                <span className="font-semibold">SYNTHETIC PERFORMER:</span> Replies are generated by a
                synthetic AI agent — no human performer is involved.
              </p>
            </div>
